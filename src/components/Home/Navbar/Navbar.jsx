      ...
      <div className="navbar-start">
        ...
        <div className="drawer lg:hidden">
          ...
          <div className="drawer-content">
            ...
            <label
              htmlFor="my-drawer"
              className="btn btn-outline border-0 text-2xl drawer-button text-white"
            >
          ...
          <div className="drawer-side">
            ...
            ></label>
            <ul className="menu p-6 w-80 min-h-full bg-cyan-900  uppercase text-xl text-slate-200">
