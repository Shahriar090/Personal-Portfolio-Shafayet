...
const Education = () => {
  ...
  return (
    <div className="education-container w-full h-auto bg-[rgb(17,17,34)] text-slate-200 px-8 md:px-8 lg:px-20 py-10">
      <section>
        <SectionTitle heading={"Education"}></SectionTitle>
      </section>

      <section className="educational-detail">
        <div className="education-data grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-4 lg:gap-6">
