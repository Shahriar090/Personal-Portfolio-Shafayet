...
const Banner = () => {
  return (
    <div className="hero w-full h-auto bg-[rgb(17,17,34)] px-8 md:px-8 lg:px-20">
      <div className="hero-items relative w-full flex flex-col lg:flex-row gap-5 md:gap-6 lg:gap-8  items-center justify-center">
        ...
        <div className="hero-texts w-full flex flex-col gap-4 md:gap-6 lg:gap-8 text-slate-300">
          ...
          >
            <button className="btn btn-md lg:btn-md border-0 border-x-2 rounded-full border-slate-300 btn-outline text-slate-300 hover:bg-[#F8B90C] ">
              View Resume
            </button>
          </Link>
        </div>
        <div className="social absolute  bottom-2 right-2 flex  gap-2 lg:gap-3 text-lg lg:text-2xl text-slate-300">
